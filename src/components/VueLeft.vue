        ...
        <el-col :span="24">
          <el-menu
            ...
            <el-submenu index="1">
              <template slot="title">
                <svg class="icon" aria-hidden="true">
                  <use xlink:href="#icon-kehuguanli3"></use>
                </svg>
                <span>客户管理</span>
              </template>
              <el-menu-item-group>
                <el-menu-item index="1-1">
                  <router-link :to="{path:'/home/selectClient'}">客户查询</router-link>
                </el-menu-item>
            ...
            <el-submenu index="2">
              <template slot="title">
                <svg class="icon" aria-hidden="true">
                  <use xlink:href="#icon-cheliangguanli-"></use>
                </svg>
                <span>车辆管理</span>
              </template>
              <el-menu-item-group>
            ...
            <el-submenu index="3">
              <template slot="title">
                <svg class="icon" aria-hidden="true">
                  <use xlink:href="#icon-fengxianguankong"></use>
                </svg>
                <span>风控管理</span>
              </template>
              <el-menu-item-group>
            ...
            <el-submenu index="4">
              <template slot="title">
                <svg class="icon" aria-hidden="true">
                  <use xlink:href="#icon-caiwuguanli3"></use>
                </svg>
                <span>财务管理</span>
              </template>
              <el-menu-item-group>
