    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="证件信息" name="certificate">
        <el-form :model="certificateForm" :rules="certificateFormRules" ref="certificateForm" label-width="120px" class="certificateForm">
          <el-form-item label="客户姓名" prop="name">
            <el-input v-model="certificateForm.name"></el-input>
          </el-form-item>
          <el-form-item label="车牌号" prop="plate">
            <el-input v-model="certificateForm.plate"></el-input>
          </el-form-item>
          <el-form-item prop="insuranceEffTime" label="保险期限">
            <el-date-picker type="date" placeholder="请选择保险期限" v-model="certificateForm.insuranceEffTime"></el-date-picker>
          </el-form-item>
          <el-form-item prop="idEffTime" label="身份证期限">
            <el-date-picker type="date" placeholder="请选择身份证期限" v-model="certificateForm.idEffTime"></el-date-picker>
          </el-form-item>
          <el-form-item prop="drivingEffTime" label="行驶证期限">
            <el-date-picker type="date" placeholder="请选择行驶证期限" v-model="certificateForm.drivingEffTime"></el-date-picker>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="submitcertificateForm('certificateForm')">立即创建</el-button>
          </el-form-item>
        </el-form>
      </el-tab-pane>
    </el-tabs>
  ...
  data() {
    ...
    return {
      ...
      certificateForm: {
        ...
        name: "",
        plate: "",
        insuranceEffTime: "", //保险期限
        idEffTime: "", //身份证期限
        drivingEffTime: "" //行驶证期限
      },
